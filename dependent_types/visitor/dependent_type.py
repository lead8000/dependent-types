...
from dependent_types.ranges import Range, RangeList, RangeSet, RangesTuple
    ...
    def __class_getitem__(self, cls, item) -> 'DependentType':
        ...
        for attr1, attr2 in zip(dependent_types, cls._attrs.keys()):
            ...
            if isinstance(attr1, Constant):
                ...
                attr1.attr = attr2
        _dict['_ranges'] = RangeList(RangesTuple(_dict['_attrs']))
        ...
        ctx    = { 'vars': vars, 'ranges': ranges, '_model_dict': deepcopy(RangesTuple(_dict['_attrs'])) }
